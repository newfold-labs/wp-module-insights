# Agent guidance – wp-module-insights

This file gives AI agents a quick orientation to the repo. For full detail, see the **docs/** directory.

## What this project is

- **wp-module-insights** – A Newfold module that handles integration of the Insights page. Registers with the Newfold Module Loader; depends on wp-module-data and wp-module-loader. Maintained by Newfold Labs.

- **Stack:** PHP 7.4+. See docs/dependencies.md.

- **Architecture:** Registers with the loader; provides insights page integration. See docs/integration.md.
