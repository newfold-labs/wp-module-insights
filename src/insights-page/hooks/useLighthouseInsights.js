...
/**
 * Fetches performance scans (with polling) and tracks scan-in-progress, matching InsightsContext + useScans
 * for use outside the Insights page (e.g. Bluehost app, wp-admin dashboard widget).
 *
